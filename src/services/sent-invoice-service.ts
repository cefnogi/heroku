...
export class GetSentInvoiceServices {
    ...
    getSentInvoiceRequest(payload): Promise<any> {
        const option = {
            headers: this.headers,
        };
        console.log(payload);
        return this.httpClient.post(this.baseApi + getDataBaseUrl.getSentInvoiceRequest, payload, option).toPromise();        
    }
