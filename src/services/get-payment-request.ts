...
export class GetPaymentRequestServices {
    ...
    getPaymentRequest(payload): Promise<any> {
        const option = {
            headers: this.headers,
        };
        console.log(payload);
        return this.httpClient.post(this.baseApi + getDataBaseUrl.getPaymentRequest, payload, option).toPromise();        
    }
