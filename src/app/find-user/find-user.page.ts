...
@Component({
  ...
  templateUrl: './find-user.page.html',
  styleUrls: ['./find-user.page.scss'],
})
export class FindUserPage implements OnInit {
  public userData: any = [];
  public renderData: any[];
  loginUID: string;
  data: any;
  constructor(public api: ApiService, private router: Router, private route: ActivatedRoute, public modalCtrl: ModalController) {
